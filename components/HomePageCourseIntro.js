        ...
        <div className="container mx-auto flex-center flex-col">
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4 w-[100%]">
                <Link href="/course">
                    <div className=" cursor-pointer w-[100%] h-[100px] sm:h-[400px] relative z-20 hover:-translate-y-1.5 transition duration-300">
                        <div className="flex items-center sm:flex-center sm:flex-col sm:justify-center sm:h-[100%]">
                            <Image src={classEight} width={100} height={100} alt="Class 8 Course" className="mr-2 sm:mr-0  mb-0 sm:mb-4 cursor-pointer"/>
                ...
                <Link href="/course">
                    <div className=" cursor-pointer w-[100%] h-[100px] sm:h-[400px] relative z-20 hover:-translate-y-1.5 transition duration-300">
                        <div className="flex items-center sm:flex-center sm:flex-col sm:justify-center sm:h-[100%]">
                            <Image src={classNine} width={100} height={100} alt="Class 8 Course" className="mr-2 sm:mr-0  mb-0 sm:mb-4 "/>
                ...
                <Link href="/course">
                    <div className=" cursor-pointer w-[100%] h-[100px] sm:h-[400px] relative z-20 hover:-translate-y-1.5 transition duration-300">
                        <div className="flex items-center sm:flex-center sm:flex-col sm:justify-center sm:h-[100%]">
                            <Image src={classTen} width={100} height={100} alt="Class 8 Course" className="mr-2 sm:mr-0  mb-0 sm:mb-4"/>
                ...
                <Link href="/course">
                    <div className=" cursor-pointer w-[100%] h-[100px] sm:h-[400px] relative z-20 hover:-translate-y-1.5 transition duration-300">
                        <div className="flex items-center sm:flex-center sm:flex-col sm:justify-center sm:h-[100%]">
                            <Image src={classEleven} width={100} height={100} alt="Class 8 Course" className="mr-2 sm:mr-0 mb-0 sm:mb-4"/>
